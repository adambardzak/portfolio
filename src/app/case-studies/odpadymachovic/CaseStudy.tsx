          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                dark:bg-green-600 dark:hover:bg-green-700 text-white rounded-lg transition-all duration-300"
                  >
                    Živá ukázka
              ...
              >
                {caseStudy.techStack.map((tech) => (
                  <span
                    key={tech}
                    className="px-4 py-2 rounded-full bg-green-500/5 dark:bg-green-400/5 
                text-green-600 dark:text-green-600 text-sm"
                  >
                    {tech}
                  </span>
                ))}
