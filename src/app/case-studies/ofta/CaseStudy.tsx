...
const caseStudy = {
  ...
  analytics: {
    clarity: {
      ...
      metrics: [
        { label: "Průměrná doba návštěvy", value: "2:37" },
        { label: "Scroll depth", value: "58.31%" },
    ...
    searchConsole: {
      ...
      metrics: [
        { label: "Celkový počet kliknutí", value: "4,25 tis." },
        { label: "Celkový počet zobrazení", value: "69,3 tis." },
        { label: "Průměrná míra prokliku", value: "6,1 %" },
        { label: "Průměrná pozice", value: "11" },
      ],
    },
    analytics: {
      image: "/projects/ofta/ofta_ga.png",
      metrics: [
        { label: "Prokliky", value: "1,5 tis." },
        { label: "Zobrazení", value: "1 tis." },
        { label: "Konverzní poměr", value: "6,1%" },
      ],
    },
  },
  cms: {
...
export default function CaseStudy() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center bg-light dark:bg-dark overflow-hidden">
        <div className="max-w-7xl mx-auto px-8 lg:px-16 w-full">
          ...
          {/* Main Content */}
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center h-fit pt-28 sm:pt-24 pb-12 md:pb-0">
            {/* Left Column */}
            <div className="space-y-8">
              ...
              >
                {caseStudy.techStack.map((tech, i) => (
                  <span
                    key={i}
                    className="px-4 py-2 rounded-full bg-ofta-blue-600/5 dark:bg-ofta-blue-600/5 
              text-ofta-blue-600 dark:text-ofta-blue-600 text-sm"
                  >
                    {tech}
                  </span>
                ))}
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-8">
              ...
              <p className="text-text-muted-light dark:text-text-muted-dark text-lg leading-relaxed">
                Důraz na mobilní zobrazení byl klíčový, protože více než 70%
      ...
      <section className="bg-white dark:bg-[#161616] py-32 border-t border-border-light dark:border-border-dark">
        <div className="max-w-7xl mx-auto px-8 lg:px-16">
          <h2 className="text-3xl text-text-light dark:text-text-dark mb-16">
            Výkon a Metriky
          </h2>
            ...
            {caseStudy.performance.metrics.map((metric, i) => (
              ...
              >
                <div className="flex flex-col h-full justify-between">
                  <p className="text-text-muted-light dark:text-text-muted-dark mb-4 font-medium uppercase tracking-wide text-sm">
                    {metric.label}
                  </p>
                  <div className="flex items-end">
                    <span
                      className="text-5xl font-monument text-text-light dark:text-text-dark 
                      bg-gradient-to-r from-ofta-blue-600 to-blue-500 bg-clip-text text-transparent
              ...
              <div className="grid gap-4">
                {caseStudy.analytics.clarity.metrics
                  ...
                  .map((metric, i) => (
                    ...
                    >
                      <p
                        className="text-sm text-text-muted-light dark:text-text-muted-dark mb-2 
                        group-hover:text-ofta-blue-600 transition-colors"
                      >
                        {metric.label}
                      </p>
