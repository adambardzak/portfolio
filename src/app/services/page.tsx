          ...
          <div className="max-w-3xl mb-32">
            ...
            >
              ...
              <p className="text-text-muted-light dark:text-text-muted-dark text-lg md:text-xl">
                Specializuji se na vývoj moderních webových aplikací a
                e-commerce řešení. Díky spolupráci s talentovanými profesionály
                můžu nabídnout i kompletní řešení včetně designu a marketingu.
              </p>
            </motion.div>
          </div>
